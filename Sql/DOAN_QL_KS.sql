...
/*=============================================================
================= TAO DATABASE (TUNG, VIET) ===================
=============================================================*/
Declare @Primary_Path nvarchar(max), @Secon_Path nvarchar(max), @Log_Path nvarchar(max)
Select	@Primary_Path = N'D:\.Năm 3\HQTCSDL\Thuc Hanh\Đồ Án_1\Đồ án\DOAN_ThucHanhHQTCSDL_QLKhachSan (new) (9) (1)\Sql\Primary file',
		@Secon_Path = N'D:\.Năm 3\HQTCSDL\Thuc Hanh\Đồ Án_1\Đồ án\DOAN_ThucHanhHQTCSDL_QLKhachSan (new) (9) (1)\Sql\Secondary File',
		@Log_Path = N'D:\.Năm 3\HQTCSDL\Thuc Hanh\Đồ Án_1\Đồ án\DOAN_ThucHanhHQTCSDL_QLKhachSan (new) (9) (1)\Sql\Log file'
...
FROM 'D:\.Năm 3\HQTCSDL\Thuc Hanh\Đồ Án_1\Đồ án\DOAN_ThucHanhHQTCSDL_QLKhachSan (new) (9) (1)\Sql\Import data\Excel for bulk\KhachHang.csv'
with
	(
		CHECK_CONSTRAINTS,
		CODEPAGE=65001,
...
FROM 'D:\.Năm 3\HQTCSDL\Thuc Hanh\Đồ Án_1\Đồ án\DOAN_ThucHanhHQTCSDL_QLKhachSan (new) (9) (1)\Sql\Import data\Excel for bulk\NhanVien.csv'
with
	(
		CHECK_CONSTRAINTS,
		CODEPAGE=65001,
...
-- PHONG
BULK INSERT PHONG
FROM 'D:\.Năm 3\HQTCSDL\Thuc Hanh\Đồ Án_1\Đồ án\DOAN_ThucHanhHQTCSDL_QLKhachSan (new) (9) (1)\Sql\Import data\Excel for bulk\Phong.csv'
with
	(
		CHECK_CONSTRAINTS,
		CODEPAGE=65001,
...
-- THUE
BULK INSERT THUE
FROM 'D:\.Năm 3\HQTCSDL\Thuc Hanh\Đồ Án_1\Đồ án\DOAN_ThucHanhHQTCSDL_QLKhachSan (new) (9) (1)\Sql\Import data\Excel for bulk\Thue.csv'
with
	(
		CHECK_CONSTRAINTS,
		CODEPAGE=65001,
...
-- HOADON
BULK INSERT HOADON
FROM 'D:\.Năm 3\HQTCSDL\Thuc Hanh\Đồ Án_1\Đồ án\DOAN_ThucHanhHQTCSDL_QLKhachSan (new) (9) (1)\Sql\Import data\Excel for bulk\HoaDon.csv'
with
	(
		CHECK_CONSTRAINTS,
		CODEPAGE=65001,
...
FROM OPENDATASOURCE('Microsoft.ACE.OLEDB.12.0',
    N'Data Source=D:\.Năm 3\HQTCSDL\Thuc Hanh\Đồ Án_1\Đồ án\DOAN_ThucHanhHQTCSDL_QLKhachSan (new) (9) (1)\Sql\Import data\Excel for opendatasource\DuLieu.xlsx;
...
as
begin
    if  ((select Count(*) from KHACHHANG where MA_KH = @Makh)>1)
			return 1
	else return 0
end
go
